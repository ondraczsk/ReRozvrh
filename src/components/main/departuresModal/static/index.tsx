...
import { fetchDeparturesStatic } from "@/functions/main/departuresModal/fetchDepartures/static";
import { getRouteIcon } from "@/functions/main/departuresModal/getRouteIcon";

const DeparturesModalStatic: React.FC<DeparturesModalProps> = ({
  isOpen,
  onClose,
        ...
        <ModalHeader>
          ...
          <HStack gap={1}>
            <Text fontSize="md" fontWeight="400">
              {previousBuildingCode === "HO" ||
              (previousBuildingCode === "FL" && currentBuildingCode == "HO") ||
              (previousBuildingCode === "KO" && currentBuildingCode == "HO")
                ? "tramvají ze zastávky "
                : (previousBuildingCode === "FL" &&
                    currentBuildingCode == "KO") ||
                  (previousBuildingCode === "KO" && currentBuildingCode == "FL")
                ? "metra ze stanice "
                : ""}
            </Text>
            <Text fontSize="xl" fontWeight="400">
              {previousBuildingCode === "HO"
                ? "Albertov"
                : previousBuildingCode === "FL" && currentBuildingCode == "KO"
                ? "Florenc-B"
                : previousBuildingCode === "FL" && currentBuildingCode == "HO"
                ? "Bílá labuť"
                : previousBuildingCode === "KO"
                ? "Národní třída"
                : ""}
            </Text>
          </HStack>
...
export default DeparturesModalStatic;
